...
class ContactProvider extends yupe\models\YModel
{
	...
	{
		return array(
			'id' => Yii::t('ContactModule.contactprovider', 'ID'),
			'code' => Yii::t('ContactModule.contactprovider', 'Code'),
			'name' => Yii::t('ContactModule.contactprovider', 'Name'),
			'template' => Yii::t('ContactModule.contactprovider', 'Template'),
			'icon' => Yii::t('ContactModule.contactprovider', 'Icon'),
			'fa_css_class' => Yii::t('ContactModule.contactprovider', 'Fa Css Class'),
		);
	}
